...
import {isAccountLinked, isLoggedIn, getUsername} from "./auth";
      ...
      <Box sx={{width: 65}}>
        <FormControl variant="standard" fullWidth sx={{margin: 0}}>
          ...
          <Select
            ...
            sx={{
              "color": "#f6f7f9",
              ":before": {borderBottomColor: "#878fa0"},
              ".MuiSelect-icon": {color: "#f6f7f9"},
            }}
          >
            {options.map((option) => (
    ...
    return (
      <>
        <Grid
          container
          spacing={3}
          sx={{marginBottom: 0.75, width: "fit-content"}}
        >
          <Grid item>
            ...
            <>
              <Grid item xs={12} sm={12} lg={2.5} height={"33vh"}>
                <Typography
                  variant="h6"
                  noWrap
                  sx={{color: "#878fa0", width: "fit-content"}}
                >
                  Distribution
                </Typography>
              ...
              <Grid item xs={12} sm={12} lg={6} height={"33vh"}>
                <Typography variant="h6" noWrap sx={{color: "#878fa0"}}>
                  Spendings
                </Typography>
