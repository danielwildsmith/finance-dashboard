...
const CustomToolbar = () => {
  return (
    <GridToolbarContainer sx={{justifyContent: "space-between"}}>
      <Typography variant="h6" noWrap sx={{color: "#139eca"}}>
        Accountant
      </Typography>
      <div
...
export const BasicEditingGrid = ({
    ...
    if (newRow.note !== oldRow.note) {
      ...
      try {
        ...
        const message = newRow.verified ?
          ...
          "Transaction successfully unverified";
  ...
  const renderRow = (params: GridRowParams) => {
    return (
      <div style={{borderBottom: "1px solid #878fa0"}}>{params.row.name}</div>
    );
  };
        ...
        >
          <DataGrid
            ...
            sx={{
              ...
              "color": "#878fa0",
              "border": 0,
              "& .MuiDataGrid-toolbarContainer": {margin: 0, padding: 0},
