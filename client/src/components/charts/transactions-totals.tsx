...
export const MonthlyTotalGraph = ({
  data,
}: {
  data: MonthlyTotalData[] | null;
}) => {
  if (data) {
    return (
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Tooltip
            ...
            formatter={CustomOnHoverValueFormatter}
          />
                    ...
                    content={({value, x, y, width, height}) => (
                      <g>
                        <line
                          ...
                          x2={Number(x) + Number(width) + 8}
                          y2={Number(y) + Number(height) / 2}
                          stroke="#878fa0"
                          strokeWidth={1}
                        />
                        <text
                          x={Number(x) + Number(width) + 32}
