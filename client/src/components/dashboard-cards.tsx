    ...
    if (data) {
      if (data.available) {
        const percentageChange =
          ((data.recentAmount - data.previousAmount) /
            Math.abs(data.previousAmount)) *
          100;
        ...
        if (roundedPercentageChange >= 0) {
          return (
            <div
              style={{
                ...
                marginTop: 12,
                paddingBottom: 12,
                borderBottom: "1px solid #444c5d",
                justifyContent: "center",
                alignItems: "center",
              }}
            >
              <NorthOutlined sx={{color: "#1ebd1e", fontSize: 28}} />
              <Typography variant="h6" sx={{color: "#1ebd1e"}}>
          ...
          return (
            ...
            >
              ...
              <Typography variant="h6" sx={{color: "#d12631"}}>
                {roundedPercentageChange}%
              </Typography>
            </div>
          );
        ...
        return (
          ...
          >
            <Typography
              variant="h6"
              sx={{textAlign: "center", color: "#707787"}}
            >
      ...
      <Container>
        <Card sx={{minWidth: 275, backgroundColor: "#343a46"}}>
          <CardContent sx={{marginBottom: 0, paddingBottom: 0}}>
            ...
            >
              {type === "balances" ? (
                <AccountBalanceIcon sx={{color: "#139eca", fontSize: 32}} />
              ) : (
                <CreditCard sx={{color: "#139eca", fontSize: 32}} />
              )}
              <Typography
                variant="h4"
                sx={{color: "#707787", width: "100%", textAlign: "center"}}
              >
            ...
            >
              $
              {data.recentAmount.toLocaleString(undefined, {
          ...
          >
            ...
            >
              <Typography variant="body1" sx={{color: "#707787"}}>
                This month
              </Typography>
              <Button
                style={{color: "#139eca", padding: 0}}
        ...
        {!accountLinked ? (
          <>
            <Typography
              variant="h5"
              color={"#878fa0"}
              sx={{maxWidth: "60vw", textAlign: "center"}}
            >
              Link a financial account to learn detailed insights about your
              transactions and balances, powered by Plaid.
            </Typography>
          </>
        ) : (
